...
public class Main {
   ...
   public static void main(String []args) {
      ...
      System.out.println(Math.abs(-99.999));
      ...
      // and raises the first one to the power of the second
